...
// Replace all broken CSS rules in superadmin.html
...
// Clean any residual broken Spanish accents
...
// Also update nodos-app/dist/superadmin.html so it doesn't revert!
fs.writeFileSync(path.join(rootDir, 'nodos-app', 'dist', 'superadmin.html'), sp, 'utf8');
...
console.log('✔ Permanently fixed CSS and synced all directories.');
